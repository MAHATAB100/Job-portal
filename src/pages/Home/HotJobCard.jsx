...
const HotJobCard = ({job}) => {
    ...
    return (
        <div className="card card-compact bg-base-100  shadow-xl mt-3 border-y-2 ">
    ...
    <div className='flex gap-2 flex-wrap'>
        {
            requirements.map(skill => <p 
                className='border rounded-md text-center px-2 hover:text-blue-800 hover:bg-green-500'
